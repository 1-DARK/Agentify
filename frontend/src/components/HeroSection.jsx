  ...
  return (
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden py-20">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-20 right-10 w-64 h-64 bg-neon-pink/15 rounded-full blur-3xl animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-white text-4xl sm:text-5xl md:text-6xl font-black">
                Interviews
              </span>
            </motion.h1>
            ...
            >
              Master Node.js, System Design, DevOps & more through real
              interview questions with instant AI evaluation.
            </motion.p>
